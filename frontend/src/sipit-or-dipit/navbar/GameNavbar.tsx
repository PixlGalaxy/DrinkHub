        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {roomCode && (
            <div className="flex items-center gap-1.5 glass hover:glass-strong transition-all
              ...
              <span className="text-xs sm:text-sm font-mono font-black text-yellow-400 hover:text-emerald-400 tracking-[0.1em] transition-colors">
                {roomCode}
              </span>
            </div>
          )}
          {onLeave && (
            <button
              ...
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg glass hover:glass-strong hover:bg-red-500/20
                         flex items-center justify-center text-white/50 hover:text-red-400 transition-all glow-amber-hover
                         active:scale-95"
